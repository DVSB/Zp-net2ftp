                          ...
                          <tbody>
                            <tr> 
                              <td class="text_white" style="background-image:url(<?php echo $net2ftp_globals["image_url"]; ?>/backgrounds/footerbgline2.gif); height: 41px; text-align: center;">
                                <a href="<?php echo $net2ftp_globals["application_rootdir_url"]; ?>/help.html" class="text_white"><?php echo __("Help Guide"); ?></a> | <a href="<?php echo $net2ftp_globals["application_rootdir_url"]; ?>/LICENSE.txt" class="text_white"><?php echo __("License"); ?></a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
