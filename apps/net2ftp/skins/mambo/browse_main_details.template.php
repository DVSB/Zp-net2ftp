...
<!-- Template /skins/mambo/browse_main_details.template.php begin -->
...
<table align="center" style="width: 100%; margin-top: 5px;" border="0" cellspacing="0" cellpadding="0">
	<tr valign="bottom">
		<td style="text-align: <?php echo __("left"); ?>;">
			<input type="text" name="directory" value="<?php echo $directory_html; ?>" style="width: 220px;" title="(accesskey g)" accesskey="g" /> 
...
<?php			if ($net2ftp_globals["state"] != "bookmark") { printActionIcon("bookmark", "document.forms['BrowseForm'].state.value='bookmark';document.forms['BrowseForm'].submit();"); } ?>
...
<?php			printActionIcon("logout",   "document.forms['BrowseForm'].state.value='logout';document.forms['BrowseForm'].submit();"); ?>
		</td>
	...
	<tr valign="top">
		<td colspan="<?php echo $action_colspan; ?>">
			<span style="font-size: 90%;"><?php echo __("Directory Tree"); ?>: <?php echo $directory_tree; ?></span>
		</td>
	</tr>
</table>
...
<?php /* ----- Statistics ----- */ ?>
<div style="font-size: 90%; margin-top: 10px; margin-left: 10px;">
...
<div style="text-align: center; margin-top: 20px;"><?php require_once($net2ftp_globals["application_skinsdir"] . "/" . $net2ftp_globals["skin"] . "/google_browse.template.php"); ?></div>

	</div>
<?php require_once($net2ftp_globals["application_skinsdir"] . "/" . $net2ftp_globals["skin"] . "/footer.template.php"); ?>
<!-- Template /skins/mambo/browse_main_details.template.php end -->
